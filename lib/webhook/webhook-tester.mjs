...
if (type === 'teams') {
      ...
      "rows": [
        ...
        },
        {
          ...
          "cells": [
            ...
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `57.30 ms ${avgOk ? "✓" : "✗"}`, "color": avgOk ? "Good" : "Attention" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `${overallErr.toFixed(2)}% ${errOk ? "✓" : "✗"}`, "color": errOk ? "Good" : "Attention" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `${totalRps.toFixed(2)} ${rpsOk ? "✓" : "✗"}`, "color": rpsOk ? "Good" : "Attention" }] },
    ...
    },
    {
      ...
      "rows": [
        ...
        },
        {
          "type": "TableRow",
          "cells": [
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": "1", "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": "Daily Trade Marketdata", "size": "Small", "wrap": true }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": String(totalReqs), "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": "47.42", "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": "57.30", "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": "0.00%", "size": "Small", "color": "Good" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": totalRps.toFixed(2), "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": "0", "size": "Small" }] }
          ]
        },
        {
          "type": "TableRow",
          ...
          "cells": [
            ...
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `**${totalReqs}**`, "weight": "Bolder", "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `**47.42**`, "weight": "Bolder", "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `**57.30**`, "weight": "Bolder", "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `**0.00%**`, "weight": "Bolder", "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `**${totalRps.toFixed(2)}**`, "weight": "Bolder", "size": "Small" }] },
            { "type": "TableCell", "items": [{ "type": "TextBlock", "text": `**0**`, "weight": "Bolder", "size": "Small" }] }
          ]
        }
      ]
    }
  ...
  let html = `<b>🧪 PT Run Report — ${esc(demoSuite)}</b>\n\n`;
  html += `<b>Status :</b> ${esc(statusText.replace(/^##\s*/, ''))}\n`;
  html += `<b>Reason :</b> ${esc(reason)}\n\n`;
  html += `<pre>\n`;
  html += `Target    : ${esc(demoTarget)}\n`;
  html += `Run by    : ${esc(demoUser)}\n`;
  html += `Execution : ${demoDur} duration\n`;
  html += `Start     : ${esc(demoStart)}\n`;
  html += `End       : ${esc(demoEnd)}\n`;
  html += `Avg TPS   : ${avgTps.toFixed(2)}\n`;
  html += `</pre>\n\n`;
  ...
  html += `-----------------------------------------\n`;
  html += `Daily Trade  |1045|  47|  57| 0.0%| 348\n`;
  html += `</pre>\n`;
