...
const Order_V2_Protected_OrderList = {
    Order_V2_Protected_OrderList: {
        errorCount: new Counter("error_count_Order_V2_Protected_OrderList"),
        errorRate: new Rate("error_rate_Order_V2_Protected_OrderList"),
        httpDuration: new Trend("duration_Order_V2_Protected_OrderList"),
        httpWaiting: new Trend("waiting_Order_V2_Protected_OrderList"),
        requestRate: new Counter("rps_Order_V2_Protected_OrderList"),
        http_reqs: new Counter("sample_Order_V2_Protected_OrderList"),
    },
};
