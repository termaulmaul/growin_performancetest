...
// GET_Order_V2_Protected_OrderList

// Define custom metrics
const Order_V2_Protected_OrderList = {
    Order_V2_Protected_OrderList: {
        errorCount: new Counter("error_count_001_01_06_Order_V2_Protected_OrderList"),
        errorRate: new Rate("error_rate_001_01_06_Order_V2_Protected_OrderList"),
        httpDuration: new Trend("duration_001_01_06_Order_V2_Protected_OrderList"),
        httpWaiting: new Trend("waiting_001_01_06_Order_V2_Protected_OrderList"),
        requestRate: new Counter("rps_001_01_06_Order_V2_Protected_OrderList"),
        http_reqs: new Counter("sample_001_01_06_Order_V2_Protected_OrderList"),
    },
};
...
export function BP006(data) {
    ...
    // ─── Batch 2 - Refresh_Token_Pass ───────────────────────────────────────────────────
    {
        ...
        responses.forEach((response, index) => {
            const metrics = [
                Order_V2_Protected_OrderList.Order_V2_Protected_OrderList
            ]
