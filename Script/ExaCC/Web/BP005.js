...
// /auth/api/v1/protected/pin-login

// ===================================================

// POST_Auth_Protected_PinLogin
...
export function BP005(data) {
    ...
    // ─── Batch 2 - Refresh_Token_Pass ───────────────────────────────────────────────────
    {
        ...
        const responses = [
        http.post(urls[0], Auth_Protected_AdminPinLogin_Payload, { headers: headersAfterPin })
    ];

        responses.forEach((response, index) => {
            const metrics = [
                Auth_Protected_PinLogin.Auth_Protected_PinLogin
            ]
