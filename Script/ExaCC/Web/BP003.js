...
// GET_User_Protected_Profile_CollateralRatio
...
export function BP003(data) {
    ...
    {
        const urls = [
            base_url + `/user/api/protected/v1/profile/collateral-ratio`,
        ];
        ...
        responses.forEach((response, index) => {
            const metrics = [
                User_Protected_Profile_CollateralRatio.User_Protected_Profile_CollateralRatio
            ]
