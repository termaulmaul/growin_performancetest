...
// /user/api/protected/v1/portfolio/stock-exercise

// ===================================================

// GET_User_Protected_Portfolio_StockExercise
...
export function BP009(data) {
    ...
    {
        const urls = [
            base_url + `/user/api/protected/v1/portfolio/stock-exercise`,
        ];
        ...
        responses.forEach((response, index) => {
            const metrics = [
                User_Protected_Portfolio_StockExercise.User_Protected_Portfolio_StockExercise
            ]
