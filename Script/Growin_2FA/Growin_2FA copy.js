...
// Run Single BP Web
// ../../k6 run Growin_2FA.js -e RUNBY=Manual -e ENV=INT -e USER=1000 -e DURATION=5m -e NUMSTART=1 -e SCENARIO=BP001 -e PLATFORM=Web --out dashboard=export=../../Report/Growin_2FA/Web/BP001/Manual/Manual_DryRun_0504_1020_BP001.html
// ../../k6 run Growin_2FA.js -e RUNBY=Manual -e ENV=INT -e USER=335 -e DURATION=15m -e NUMSTART=1 -e SCENARIO=BP002 -e PLATFORM=Web --out dashboard=export=../../Report/Growin_2FA/Web/BP002/Manual/Manual_DryRun_0430_1016_BP002.html
...
export function setup() {
    ...
    selectedBPs.forEach((bp, bpIndex) => {
        ...
        // ✅ NEW: jika skipSetupLogin, assign hanya email — skip semua HTTP call
        if (skipSetupLogin) {
    ...
    // ✅ NEW: tampilkan info BP yang skip login
