...
const Home = {
    ...
    Auth_Protected_Otp_Status: {
        errorCount: new Counter("error_count_Auth_Protected_Otp_Status"),
        errorRate: new Rate("error_rate_Auth_Protected_Otp_Status"),
        httpDuration: new Trend("duration_Auth_Protected_Otp_Status"),
        httpWaiting: new Trend("waiting_Auth_Protected_Otp_Status"),
        requestRate: new Counter("rps_Auth_Protected_Otp_Status"),
        http_reqs: new Counter("sample_Auth_Protected_Otp_Status"),
    },
};
...
const VerifyPage = {
    ...
    Auth_Protected_Otp_Request: {
        errorCount: new Counter("error_count_Auth_Protected_Otp_Request"),
        errorRate: new Rate("error_rate_Auth_Protected_Otp_Request"),
        httpDuration: new Trend("duration_Auth_Protected_Otp_Request"),
        httpWaiting: new Trend("waiting_Auth_Protected_Otp_Request"),
        requestRate: new Counter("rps_Auth_Protected_Otp_Request"),
        http_reqs: new Counter("sample_Auth_Protected_Otp_Request"),
    },
    Auth_Protected_Otp_Validate: {
        errorCount: new Counter("error_count_Auth_Protected_Otp_Validate"),
        errorRate: new Rate("error_rate_Auth_Protected_Otp_Validate"),
        httpDuration: new Trend("duration_Auth_Protected_Otp_Validate"),
        httpWaiting: new Trend("waiting_Auth_Protected_Otp_Validate"),
        requestRate: new Counter("rps_Auth_Protected_Otp_Validate"),
...
const DeviceManagement = {
    ...
    Auth_Protected_VerifiedDevice_ID: {
        errorCount: new Counter("error_count_Auth_Protected_VerifiedDevice_Delete"),
        errorRate: new Rate("error_rate_Auth_Protected_VerifiedDevice_Delete"),
        httpDuration: new Trend("duration_Auth_Protected_VerifiedDevice_Delete"),
        httpWaiting: new Trend("waiting_Auth_Protected_VerifiedDevice_Delete"),
        requestRate: new Counter("rps_Auth_Protected_VerifiedDevice_Delete"),
        http_reqs: new Counter("sample_Auth_Protected_VerifiedDevice_Delete"),
    },
};
    ...
    let token = null;
    {
        ...
        responses.forEach((response, index) => {
            ...
            if (response.status === 200) {
                ...
                if (`${__ENV.ENV}` != 'INT') {
                    // /* log disabled */ (`${email} ${url} || Status: ${response.status} || Body: ${response.body}`);
                }
            } else {
    ...
    let deviceIdToDelete = null;
    {
        ...
        responses.forEach((response) => {
            ...
            if (response.status === 200) {
                ...
                metric.http_reqs.add(1);
                if (`${__ENV.ENV}` != 'INT') {
                    // /* log disabled */ (`${email} ${url} || Status: ${response.status} || Response: ${response.body}`);
                }
            } else {
                metric.errorRate.add(true);
                metric.errorCount.add(1);
