# enchange_Growin_Template — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_Template.js` |
| Original | `Growin_Template.js` |
| Runner | `Script/Template_Project/enchange_Growin_Template.js` |
| Config | env-driven |
| Suite | `Template_Project` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_Template.js` | see `.refresh_report.json` |
