// ─────────────────────────────────────────────────────────────────────────────
// Growin_Dynamic_Menu.js — k6 Load Test Script
// ─────────────────────────────────────────────────────────────────────────────
//
// COMMAND EXAMPLES:
//
// Run Multiple BP (LoadTest):
//   ../../../k6 run Growin_Dynamic_Menu_LoadTest.js -e RUNBY=LoadTest -e ENV=INT -e USER=316 -e DURATION=5m -e NUMSTART=101 -e PLATFORM=Web --out dashboard=export=../../../Report/Growin_Dynamic_Menu/Web/LoadTest/Manual_LoadTest_0107_1459.html
//
// Run Single BP Web:
//   ../../k6 run Growin_Dynamic_Menu.js -e RUNBY=Manual -e ENV=INT -e USER=1000 -e DURATION=15m -e NUMSTART=1 -e SCENARIO=BP001 -e PLATFORM=Web --out dashboard=export=../../Report/Growin_Dynamic_Menu/Web/BP001/Manual/Manual_DryRun_0506_1353_BP001.html
//
// Run Single BP iOS:
//   ../../k6 run Growin_Dynamic_Menu.js -e RUNBY=Manual -e ENV=INT -e USER=335 -e DURATION=5m -e NUMSTART=1 -e SCENARIO=BP001 -e PLATFORM=iOS --out dashboard=export=../../Report/Growin_Dynamic_Menu/iOS/BP001/Manual/Manual_DryRun_0428_1403_BP001.html
//
// Run Single BP Android:
//   ../../k6 run Growin_Dynamic_Menu.js -e RUNBY=Manual -e ENV=INT -e USER=335 -e DURATION=5m -e NUMSTART=1 -e SCENARIO=BP001 -e PLATFORM=Android --out dashboard=export=../../Report/Growin_Dynamic_Menu/Android/BP001/Manual/Manual_DryRun_0428_1100_BP001.html
//
// ─────────────────────────────────────────────────────────────────────────────
...
export function handleSummary(data) {
    try {
        ...
        const reportDirs = {
            Manual:     `../../Report/Growin_Dynamic_Menu/${platform}/${bp_name}/Manual`,
            Regression: `../../Report/Growin_Dynamic_Menu/${platform}/${bp_name}/Regression`,
            LoadTest:   `../../Report/Growin_Dynamic_Menu/${platform}/LoadTest`,
        };
