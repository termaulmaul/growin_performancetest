...
const Home = {
    User_Profile_Status: {
        errorCount: new Counter("error_count_User_Profile_Status"),
        errorRate: new Rate("error_rate_User_Profile_Status"),
        httpDuration: new Trend("duration_User_Profile_Status"),
        httpWaiting: new Trend("waiting_User_Profile_Status"),
        requestRate: new Counter("rps_User_Profile_Status"),
        http_reqs: new Counter("sample_User_Profile_Status"),
    },
    Auth_Protected_AccountCenter_Status: {
    ...
    Socialinvesting_CommunityProfile_Login: {
        errorCount: new Counter("error_count_Socialinvesting_CommunityProfile_Login"),
        errorRate: new Rate("error_rate_Socialinvesting_CommunityProfile_Login"),
        httpDuration: new Trend("duration_Socialinvesting_CommunityProfile_Login"),
        httpWaiting: new Trend("waiting_Socialinvesting_CommunityProfile_Login"),
        requestRate: new Counter("rps_Socialinvesting_CommunityProfile_Login"),
        http_reqs: new Counter("sample_Socialinvesting_CommunityProfile_Login"),
    },
    Auth_Protected_GetConfig: {
    ...
    Marketdata_StockRankExplore: {
        errorCount: new Counter("error_count_Marketdata_StockRankExplore"),
        errorRate: new Rate("error_rate_Marketdata_StockRankExplore"),
        httpDuration: new Trend("duration_Marketdata_StockRankExplore"),
        httpWaiting: new Trend("waiting_Marketdata_StockRankExplore"),
        requestRate: new Counter("rps_Marketdata_StockRankExplore"),
        http_reqs: new Counter("sample_Marketdata_StockRankExplore"),
    },
    User_Watchlistgroup: {
    ...
    Socialinvesting_Channel_JoinedByUser: {
        errorCount: new Counter("error_count_Socialinvesting_Channel_JoinedByUser"),
        errorRate: new Rate("error_rate_Socialinvesting_Channel_JoinedByUser"),
        httpDuration: new Trend("duration_Socialinvesting_Channel_JoinedByUser"),
        httpWaiting: new Trend("waiting_Socialinvesting_Channel_JoinedByUser"),
        requestRate: new Counter("rps_Socialinvesting_Channel_JoinedByUser"),
        http_reqs: new Counter("sample_Socialinvesting_Channel_JoinedByUser"),
    },
    Socialinvesting_CommunityProfile_GetProfile: {
        errorCount: new Counter("error_count_Socialinvesting_CommunityProfile_GetProfile"),
        errorRate: new Rate("error_rate_Socialinvesting_CommunityProfile_GetProfile"),
        httpDuration: new Trend("duration_Socialinvesting_CommunityProfile_GetProfile"),
        httpWaiting: new Trend("waiting_Socialinvesting_CommunityProfile_GetProfile"),
        requestRate: new Counter("rps_Socialinvesting_CommunityProfile_GetProfile"),
        http_reqs: new Counter("sample_Socialinvesting_CommunityProfile_GetProfile"),
    },
    Mutualfund_MutualFund_List: {
    ...
    User_Watchlist_ID: {
        errorCount: new Counter("error_count_User_Watchlist_ID"),
        errorRate: new Rate("error_rate_User_Watchlist_ID"),
        httpDuration: new Trend("duration_User_Watchlist_ID"),
        httpWaiting: new Trend("waiting_User_Watchlist_ID"),
        requestRate: new Counter("rps_User_Watchlist_ID"),
        http_reqs: new Counter("sample_User_Watchlist_ID"),
    },
    Auth_Client_Validate: {
        errorCount: new Counter("error_count_Auth_Client_Validate"),
        errorRate: new Rate("error_rate_Auth_Client_Validate"),
