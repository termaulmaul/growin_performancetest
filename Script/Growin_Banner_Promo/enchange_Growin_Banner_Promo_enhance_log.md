# enchange_Growin_Banner_Promo — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_Banner_Promo.js` |
| Original | `Growin_Banner_Promo.js` |
| Runner | `Script/Growin_Banner_Promo/enchange_Growin_Banner_Promo.js` |
| Config | env-driven |
| Suite | `Growin_Banner_Promo` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_Banner_Promo.js` | see `.refresh_report.json` |
