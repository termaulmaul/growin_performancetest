# enchange_Growin_PT_Dev — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_PT_Dev.js` |
| Original | `Growin_PT_Dev.js` |
| Runner | `Script/Growin_PT_Dev[ToDo]/enchange_Growin_PT_Dev.js` |
| Config | env-driven |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_PT_Dev.js` | see `.refresh_report.json` |
