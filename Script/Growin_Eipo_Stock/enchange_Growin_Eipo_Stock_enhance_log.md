# enchange_Growin_Eipo_Stock — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_Eipo_Stock.js` |
| Original | `Growin_Eipo_Stock.js` |
| Runner | `Script/Growin_Eipo_Stock/enchange_Growin_Eipo_Stock.js` |
| Config | env-driven |
| Suite | `Growin_Eipo_Stock` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_Eipo_Stock.js` | see `.refresh_report.json` |
