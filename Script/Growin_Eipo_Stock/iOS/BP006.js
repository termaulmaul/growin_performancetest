...
const OrderFormScreen = {
    ...
    Eipo_Order: {
        errorCount: new Counter("error_count_Eipo_Order"),
        errorRate: new Rate("error_rate_Eipo_Order"),
        httpDuration: new Trend("duration_Eipo_Order"),
        httpWaiting: new Trend("waiting_Eipo_Order"),
        requestRate: new Counter("rps_Eipo_Order"),
        http_reqs: new Counter("sample_Eipo_Order"),
    },
    Eipo_Pipeline_EMSM: {
