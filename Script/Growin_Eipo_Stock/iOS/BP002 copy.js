...
// ##READ ME
//BP002 - Order List  Screen
//RUN QA : ../../../k6 run BP002.js -e RUNBY=Manual -e ENV=QA -e USER=10 -e DURATION=1m -e NUMSTART=98 --out dashboard=export=../../../Report/Growin_Eipo_Stock/iOS/BP002/Manual/Manual_DryRun_1029_1122_BP002.html
//RUN INT: ../../../k6 run BP002.js -e RUNBY=Manual -e ENV=INT -e USER=316 -e DURATION=1m -e NUMSTART=101 --out dashboard=export=../../../Report/Growin_Eipo_Stock/iOS/BP002/Manual/Manual_DryRun_1111_2322_BP002.html
//RUN STRESS TEST: ../../k6 run BP002.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Eipo_Stock/iOS/BP002/Manual/Manual_DryRun_2021_1128_BP002.html
...
const OrderListScreen = {
    Eipo_Order: {
        errorCount: new Counter("error_count_002_01_01_Eipo_Order"),
        errorRate: new Rate("error_rate_002_01_01_Eipo_Order"),
        httpDuration: new Trend("duration_002_01_01_Eipo_Order"),
        httpWaiting: new Trend("waiting_002_01_01_Eipo_Order"),
        requestRate: new Counter("rps_002_01_01_Eipo_Order"),
        http_reqs: new Counter("sample_002_01_01_Eipo_Order"),
    },
};
...
export default function (data) {
    ...
    if (token) {
        const urls = [
            base_url + `/eipo/order?page=1&per_page=20`,
        ];
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Eipo_Stock/iOS/BP002/Manual/${__ENV.RUNBY}_Detail_BP002_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Eipo_Stock/iOS/BP002/Regression/${__ENV.RUNBY}_Detail_BP002_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Eipo_Stock/iOS/BP002/LoadTest/${__ENV.RUNBY}_Detail_BP002_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
