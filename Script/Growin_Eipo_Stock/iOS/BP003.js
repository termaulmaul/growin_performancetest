...
const DetailScreen = {
    Eipo_Pipeline_CRIM_Timeline: {
        errorCount: new Counter("error_count_Eipo_Pipeline_CRIM_Timeline"),
        errorRate: new Rate("error_rate_Eipo_Pipeline_CRIM_Timeline"),
        httpDuration: new Trend("duration_Eipo_Pipeline_CRIM_Timeline"),
        httpWaiting: new Trend("waiting_Eipo_Pipeline_CRIM_Timeline"),
        requestRate: new Counter("rps_Eipo_Pipeline_CRIM_Timeline"),
        http_reqs: new Counter("sample_Eipo_Pipeline_CRIM_Timeline"),
    },
    Eipo_Investor: {
    ...
    Eipo_Pipeline_CRIM: {
        errorCount: new Counter("error_count_Eipo_Pipeline_CRIM"),
        errorRate: new Rate("error_rate_Eipo_Pipeline_CRIM"),
        httpDuration: new Trend("duration_Eipo_Pipeline_CRIM"),
        httpWaiting: new Trend("waiting_Eipo_Pipeline_CRIM"),
        requestRate: new Counter("rps_Eipo_Pipeline_CRIM"),
        http_reqs: new Counter("sample_Eipo_Pipeline_CRIM"),
    },
};
