...
// ##READ ME
//BP007 - e-IPO Edit Order Screen
//RUN QA : ../../../k6 run BP007.js -e RUNBY=Manual -e ENV=QA -e USER=316 -e DURATION=5m -e NUMSTART=101 --out dashboard=export=../../../Report/Growin_Eipo_Stock/iOS/BP007/Manual/Manual_DryRun_1110_1128_BP007.html
//RUN INT: ../../../k6 run BP007.js -e RUNBY=Manual -e ENV=INT -e USER=205 -e DURATION=5m -e NUMSTART=101 --out dashboard=export=../../../Report/Growin_Eipo_Stock/iOS/BP007/Manual/Manual_DryRun_1113_1336_BP007.html
//RUN STRESS TEST: ../../k6 run BP007.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Eipo_Stock/iOS/BP007/Manual/Manual_DryRun_2021_1128_BP007.html
...
export default function (data) {
    ...
    if (token && orderID) {
        ...
        const requests = [
            ['PATCH', urls[0], EIPO_Order_Payload, { headers: stepOneHeaders }],
        ];
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Eipo_Stock/iOS/BP007/Manual/${__ENV.RUNBY}_Detail_BP007_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Eipo_Stock/iOS/BP007/Regression/${__ENV.RUNBY}_Detail_BP007_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Eipo_Stock/iOS/BP007/LoadTest/${__ENV.RUNBY}_Detail_BP007_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
