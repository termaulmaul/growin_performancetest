 ...
 * Original: Script/Growin_OMO/Growin_OMO.js
 *
...
// Command
// Run Multiple BP
// ../../../k6 run Growin_OMO_LoadTest.js -e RUNBY=LoadTest -e ENV=INT -e USER=316 -e DURATION=5m -e NUMSTART=101 -e PLATFORM=Web  --out dashboard=export=../../../Report/Growin_OMO/Web/LoadTest/Manual_LoadTest_0107_1459.html

// Run Single BP Web
// ../../k6 run Growin_OMO.js -e RUNBY=Manual -e ENV=INT -e USER=335 -e DURATION=15m -e NUMSTART=1 -e SCENARIO=BP001 -e PLATFORM=Web --out dashboard=export=../../Report/Growin_OMO/Web/BP001/Manual/Manual_DryRun_0506_1353_BP001.html
...
// Run Single BP iOS
// ../../k6 run Growin_OMO.js -e RUNBY=Manual -e ENV=INT -e USER=1 -e DURATION=5m -e NUMSTART=1 -e SCENARIO=BP001 -e PLATFORM=iOS --out dashboard=export=../../Report/Growin_OMO/iOS/BP001/Manual/Manual_DryRun_0428_1403_BP001.html
...
const BP_CONFIG = {
    ...
    // },
    iOS: {
        BP001: { fn: BP001_iOS, skipSetupLogin: false,  numStart: 1 },
...
export function handleSummary(data) {
    try {
        ...
        if (runby === 'Manual') {
            const htmlPath = `../../Report/Growin_OMO/${platform}/${bp_name}/Manual/${runby}_Detail_${bp_name}_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../Report/Growin_OMO/${platform}/${bp_name}/Regression/${runby}_Detail_${bp_name}_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
