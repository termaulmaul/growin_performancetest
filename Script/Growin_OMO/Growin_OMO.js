...
// Run Single BP Web
// ../../k6 run Growin_OMO.js -e RUNBY=Manual -e ENV=INT -e USER=335 -e DURATION=15m -e NUMSTART=1 -e SCENARIO=BP001 -e PLATFORM=Web --out dashboard=export=../../Report/Growin_OMO/Web/BP001/Manual/Manual_DryRun_0506_1639_BP001.html
...
export function setup() {
    ...
    selectedBPs.forEach((bp, bpIndex) => {
        ...
        // /* log disabled */ (`   🔢 numStart efektif: ${NUMSTART_env + globalUserOffset} (globalUserOffset: ${globalUserOffset})`);
