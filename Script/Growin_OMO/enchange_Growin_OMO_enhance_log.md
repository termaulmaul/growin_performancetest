# enchange_Growin_OMO — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_OMO.js` |
| Original | `Growin_OMO.js` |
| Runner | `Script/Growin_OMO/enchange_Growin_OMO.js` |
| Config | env-driven |
| Suite | `Growin_OMO` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_OMO.js` | see `.refresh_report.json` |
