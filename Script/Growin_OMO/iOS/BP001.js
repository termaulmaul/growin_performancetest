...
const MarginInformationScreen = {
    Oaofinance_Margin_FinancingDetail_Margin: {
        errorCount: new Counter("error_count_Oaofinance_Margin_FinancingDetail_Margin"),
        errorRate: new Rate("error_rate_Oaofinance_Margin_FinancingDetail_Margin"),
        httpDuration: new Trend("duration_Oaofinance_Margin_FinancingDetail_Margin"),
        httpWaiting: new Trend("waiting_Oaofinance_Margin_FinancingDetail_Margin"),
        requestRate: new Counter("rps_Oaofinance_Margin_FinancingDetail_Margin"),
        http_reqs: new Counter("sample_Oaofinance_Margin_FinancingDetail_Margin"),
    },
    Oaofinance_Margin_Benefit: {
