...
//RUN QA : ../../k6 run BP010.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=50 --out dashboard=export=../../Report/OMO_Android/BP010/Manual/Manual_DryRun_2021_1528_BP010_Local.html
//RUN INT: ../../k6 run BP010.js -e RUNBY=Manual -e ENV=INT -e USER=100 -e DURATION=15m -e NUMSTART=0 --out dashboard=export=../../Report/OMO_Android/BP010/Manual/Manual_DryRun_2021_1033_BP010_Local.html
...
export function handleSummary(data) {
    ...
    if(`${__ENV.RUNBY}`=='Manual'){
        return {
            [`../../Report/OMO_Android/BP010/Manual/${__ENV.RUNBY}_Detail_BP010_${dateStr}_${timeStr}.html`]: htmlReport(data),
            'stdout': textSummary(data, { indent: ' ', enableColors: true }), // Text summary to be displayed in the terminal
        };
    } else if(`${__ENV.RUNBY}`=='Regression'){
        return {
            [`../../Report/OMO_Android/BP010/Regression/${__ENV.RUNBY}_Detail_BP010_${dateStr}_${timeStr}.html`]: htmlReport(data),
            'stdout': textSummary(data, { indent: ' ', enableColors: true }), // Text summary to be displayed in the terminal
        };
    }
}