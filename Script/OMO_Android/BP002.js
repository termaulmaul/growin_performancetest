...
const LandingPage = {
    ...
    Oaofinance_Margin_Benefit: {
        errorCount: new Counter("error_count_Oaofinance_Margin_Benefit"),
        errorRate: new Rate("error_rate_Oaofinance_Margin_Benefit"),
        httpDuration: new Trend("duration_Oaofinance_Margin_Benefit"),
        httpWaiting: new Trend("waiting_Oaofinance_Margin_Benefit"),
        requestRate: new Counter("rps_Oaofinance_Margin_Benefit"),
        http_reqs: new Counter("sample_Oaofinance_Margin_Benefit"),
    },
    Oaofinance_Margin_LeverageFee: {
        errorCount: new Counter("error_count_Oaofinance_Margin_LeverageFee"),
        errorRate: new Rate("error_rate_Oaofinance_Margin_LeverageFee"),
        httpDuration: new Trend("duration_Oaofinance_Margin_LeverageFee"),
        httpWaiting: new Trend("waiting_Oaofinance_Margin_LeverageFee"),
        requestRate: new Counter("rps_Oaofinance_Margin_LeverageFee"),
        http_reqs: new Counter("sample_Oaofinance_Margin_LeverageFee"),
    },
    Oaofinance_Margin_FinancingDetail: {
        errorCount: new Counter("error_count_Oaofinance_Margin_FinancingDetail"),
        errorRate: new Rate("error_rate_Oaofinance_Margin_FinancingDetail"),
        httpDuration: new Trend("duration_Oaofinance_Margin_FinancingDetail"),
        httpWaiting: new Trend("waiting_Oaofinance_Margin_FinancingDetail"),
        requestRate: new Counter("rps_Oaofinance_Margin_FinancingDetail"),
