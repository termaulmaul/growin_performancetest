...
//RUN INT: ../../k6 run BP007.js -e RUNBY=Manual -e ENV=INT -e USER=60 -e DURATION=15m -e NUMSTART=101 --out dashboard=export=../../Report/OMO_Android/BP007/Manual/Manual_DryRun_1038_1046_BP007_Local.html
...
export default function (data) {
    ...
    if (token) {
        ...
        if (res.status === 200) {
            ...
            if (`${__ENV.ENV}` != 'INT') {
                console.error(`VU${vuId} ${email} Failed to get eligible asset || Status: ${res.status} || ResBody: ${res.body}`);
            }
        }
    }
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../Report/OMO_Android/BP007/Manual/${__ENV.RUNBY}_Detail_BP007_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../Report/OMO_Android/BP007/Regression/${__ENV.RUNBY}_Detail_BP007_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../Report/OMO_Android/BP007/LoadTest/${__ENV.RUNBY}_Detail_BP007_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
