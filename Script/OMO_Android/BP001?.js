...
const Homescreen = {
    ...
    Auth_Pprotected_Validate: {
        errorCount: new Counter("error_count_Auth_Pprotected_Validate"),
        errorRate: new Rate("error_rate_Auth_Pprotected_Validate"),
        httpDuration: new Trend("duration_Auth_Pprotected_Validate"),
        httpWaiting: new Trend("waiting_Auth_Pprotected_Validate"),
        requestRate: new Counter("rps_Auth_Pprotected_Validate"),
        http_reqs: new Counter("sample_Auth_Pprotected_Validate"),
    },
    ...
    Marketdata_StockRankExplore_TopGainer: {
        errorCount: new Counter("error_count_Marketdata_StockRankExplore_TopGainer"),
        errorRate: new Rate("error_rate_Marketdata_StockRankExplore_TopGainer"),
        httpDuration: new Trend("duration_Marketdata_StockRankExplore_TopGainer"),
        httpWaiting: new Trend("waiting_Marketdata_StockRankExplore_TopGainer"),
        requestRate: new Counter("rps_Marketdata_StockRankExplore_TopGainer"),
        http_reqs: new Counter("sample_Marketdata_StockRankExplore_TopGainer"),
    },
    Marketdata_StockRankExplore_TopVolume: {
        errorCount: new Counter("error_count_Marketdata_StockRankExplore_TopVolume"),
        errorRate: new Rate("error_rate_Marketdata_StockRankExplore_TopVolume"),
        httpDuration: new Trend("duration_Marketdata_StockRankExplore_TopVolume"),
        httpWaiting: new Trend("waiting_Marketdata_StockRankExplore_TopVolume"),
        requestRate: new Counter("rps_Marketdata_StockRankExplore_TopVolume"),
        http_reqs: new Counter("sample_Marketdata_StockRankExplore_TopVolume"),
    },
};
