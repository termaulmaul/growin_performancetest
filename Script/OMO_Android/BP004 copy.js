...
//RUN QA : ../../k6 run BP004.js -e RUNBY=Manual -e ENV=QA -e USER=10 -e DURATION=1m -e NUMSTART=50 --out dashboard=export=../../Report/OMO_Android/BP004/Manual/Manual_DryRun_2021_1055_BP004_Local.html
//RUN INT: ../../k6 run BP004.js -e RUNBY=Manual -e ENV=INT -e USER=700 -e DURATION=15m -e NUMSTART=0 --out dashboard=export=../../Report/OMO_Android/BP004/Manual/Manual_DryRun_2021_1056_BP004_Local.html
...
export function handleSummary(data) {
    ...
    if(`${__ENV.RUNBY}`=='Manual'){
        return {
            [`../../Report/OMO_Android/BP004/Manual/${__ENV.RUNBY}_Detail_BP004_${dateStr}_${timeStr}.html`]: htmlReport(data),
            'stdout': textSummary(data, { indent: ' ', enableColors: true }), // Text summary to be displayed in the terminal
        };
    } else if(`${__ENV.RUNBY}`=='Regression'){
        return {
            [`../../Report/OMO_Android/BP004/Regression/${__ENV.RUNBY}_Detail_BP004_${dateStr}_${timeStr}.html`]: htmlReport(data),
            'stdout': textSummary(data, { indent: ' ', enableColors: true }), // Text summary to be displayed in the terminal
        };
    }
}