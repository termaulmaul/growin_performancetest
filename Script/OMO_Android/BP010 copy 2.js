...
//RUN QA : ../../k6 run BP010.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=50 --out dashboard=export=../../Report/OMO_Android/BP010/Manual/Manual_DryRun_2021_2144_BP010_Local.html
//RUN INT: ../../k6 run BP010.js -e RUNBY=Manual -e ENV=INT -e USER=316 -e DURATION=3m -e NUMSTART=1 --out dashboard=export=../../Report/OMO_Android/BP010/Manual/Manual_DryRun_2022_1137_BP010_Local.html
//RUN STRESS TEST: ../../k6 run BP010.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../Report/OMO_Android/BP010/Manual/Manual_DryRun_2021_1128_BP010_Local.html
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../Report/OMO_Android/BP010/Manual/${__ENV.RUNBY}_Detail_BP010_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../Report/OMO_Android/BP010/Regression/${__ENV.RUNBY}_Detail_BP010_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../Report/OMO_Android/BP010/LoadTest/${__ENV.RUNBY}_Detail_BP010_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
