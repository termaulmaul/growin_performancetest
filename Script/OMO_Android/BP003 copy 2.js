...
//RUN QA : ../../k6 run BP003.js -e RUNBY=Manual -e ENV=QA -e USER=10 -e DURATION=1m -e NUMSTART=40 --out dashboard=export=../../Report/OMO_Android/BP003/Manual/Manual_DryRun_2021_2131_BP003_Local.html
//RUN INT: ../../k6 run BP003.js -e RUNBY=Manual -e ENV=INT -e USER=700 -e DURATION=15m -e NUMSTART=0 --out dashboard=export=../../Report/OMO_Android/BP003/Manual/Manual_DryRun_2021_2005_BP003_Local.html
//RUN STRESS TEST: ../../k6 run BP003.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../Report/OMO_Android/BP003/Manual/Manual_DryRun_2021_1128_BP003_Local.html
...
// oaofinance/api/v1/margin/collateral-asset-information
...
const CollateralInformationBottomSheet = {
    Oaofinance_Margin_CollateralAssetInformation: {
        errorCount: new Counter("error_count_003_01_01_Oaofinance_Margin_Eligibility"),
        errorRate: new Rate("error_rate_003_01_01_Oaofinance_Margin_Eligibility"),
        httpDuration: new Trend("duration_003_01_01_Oaofinance_Margin_Eligibility"),
        httpWaiting: new Trend("waiting_003_01_01_Oaofinance_Margin_Eligibility"),
        requestRate: new Counter("rps_003_01_01_Oaofinance_Margin_Eligibility"),
        http_reqs: new Counter("sample_003_01_01_Oaofinance_Margin_Eligibility"),
    },
};
...
export default function (data) {
    ...
    if (token) {
        ...
        responses.forEach((response, index) => {
            const metrics = [
                CollateralInformationBottomSheet.Oaofinance_Margin_CollateralAssetInformation,
            ];
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../Report/OMO_Android/BP003/Manual/${__ENV.RUNBY}_Detail_BP003_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../Report/OMO_Android/BP003/Regression/${__ENV.RUNBY}_Detail_BP003_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../Report/OMO_Android/BP003/LoadTest/${__ENV.RUNBY}_Detail_BP003_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
