# enchange_OMO_Android_LoadTest — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_OMO_Android_LoadTest.js` |
| Original | `OMO_Android_LoadTest.js` |
| Runner | `OMO_Android/OMO_Android.js` |
| Config | env-driven |
| Suite | `OMO_Android` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_OMO_Android_LoadTest.js` | see `.refresh_report.json` |
