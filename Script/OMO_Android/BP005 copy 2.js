...
//RUN QA : ../../k6 run BP005.js -e RUNBY=Manual -e ENV=QA -e USER=10 -e DURATION=1m -e NUMSTART=50 --out dashboard=export=../../Report/OMO_Android/BP005/Manual/Manual_DryRun_2021_2133_BP005_Local.html
//RUN INT: ../../k6 run BP005.js -e RUNBY=Manual -e ENV=INT -e USER=1 -e DURATION=15m -e NUMSTART=1 --out dashboard=export=../../Report/OMO_Android/BP005/Manual/Manual_DryRun_2024_1607_BP005_Local.html
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../Report/OMO_Android/BP005/Manual/${__ENV.RUNBY}_Detail_BP005_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../Report/OMO_Android/BP005/Regression/${__ENV.RUNBY}_Detail_BP005_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../Report/OMO_Android/BP005/LoadTest/${__ENV.RUNBY}_Detail_BP005_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
