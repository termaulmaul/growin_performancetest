...
// ##READ ME
//Test1 - Homepage
//RUN QA : ../../k6 run Test1.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=20 --out dashboard=export=../../Report/OMO_Android/Test1/Manual/Manual_DryRun_2021_2211_Test1_Local.html
//RUN INT: ../../k6 run Test1.js -e RUNBY=Manual -e ENV=INT -e USER=1 -e DURATION=3m -e NUMSTART=1001 --out dashboard=export=../../Report/OMO_Android/Test1/Manual/Manual_DryRun_2021_1431_Test1_Local.html
//RUN STRESS TEST: ../../k6 run Test1.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../Report/OMO_Android/Test1/Manual/Manual_DryRun_2021_1128_Test1_Local.html
...
const Homepage = {
    ...
    Order_OrderStatusActionMap_1: {
        errorCount: new Counter("error_count_Order_OrderStatusActionMap_1"),
        errorRate: new Rate("error_rate_Order_OrderStatusActionMap_1"),
        httpDuration: new Trend("duration_Order_OrderStatusActionMap_1"),
        httpWaiting: new Trend("waiting_Order_OrderStatusActionMap_1"),
        requestRate: new Counter("rps_Order_OrderStatusActionMap_1"),
        http_reqs: new Counter("sample_Order_OrderStatusActionMap_1"),
    },
    Auth_Protected_AccountCenter_Status_1: {
        errorCount: new Counter("error_count_Auth_Protected_AccountCenter_Status_1"),
        errorRate: new Rate("error_rate_Auth_Protected_AccountCenter_Status_1"),
        httpDuration: new Trend("duration_Auth_Protected_AccountCenter_Status_1"),
        httpWaiting: new Trend("waiting_Auth_Protected_AccountCenter_Status_1"),
        requestRate: new Counter("rps_Auth_Protected_AccountCenter_Status_1"),
        http_reqs: new Counter("sample_Auth_Protected_AccountCenter_Status_1"),
    },
    User_Watchlistgroup: {
    ...
    News_Categories_Sharia: {
        errorCount: new Counter("error_count_News_Categories_Sharia"),
        errorRate: new Rate("error_rate_News_Categories_Sharia"),
        httpDuration: new Trend("duration_News_Categories_Sharia"),
        httpWaiting: new Trend("waiting_News_Categories_Sharia"),
        requestRate: new Counter("rps_News_Categories_Sharia"),
        http_reqs: new Counter("sample_News_Categories_Sharia"),
    },
    ...
    Bond_Sbn_Master_Product_List: {
        errorCount: new Counter("error_count_Bond_Sbn_Master_Product_List"),
        errorRate: new Rate("error_rate_Bond_Sbn_Master_Product_List"),
        httpDuration: new Trend("duration_Bond_Sbn_Master_Product_List"),
        httpWaiting: new Trend("waiting_Bond_Sbn_Master_Product_List"),
        requestRate: new Counter("rps_Bond_Sbn_Master_Product_List"),
        http_reqs: new Counter("sample_Bond_Sbn_Master_Product_List"),
    },
    Bond_Sbn_Client_Check_Status: {
    ...
    Mutualfund_Content_RiskProfile: {
        errorCount: new Counter("error_count_Mutualfund_Content_RiskProfile"),
        errorRate: new Rate("error_rate_Mutualfund_Content_RiskProfile"),
        httpDuration: new Trend("duration_Mutualfund_Content_RiskProfile"),
        httpWaiting: new Trend("waiting_Mutualfund_Content_RiskProfile"),
        requestRate: new Counter("rps_Mutualfund_Content_RiskProfile"),
        http_reqs: new Counter("sample_Mutualfund_Content_RiskProfile"),
    },
    Order_OrderStatusActionMap_2: {
        errorCount: new Counter("error_count_Order_OrderStatusActionMap_2"),
        errorRate: new Rate("error_rate_Order_OrderStatusActionMap_2"),
        httpDuration: new Trend("duration_Order_OrderStatusActionMap_2"),
        httpWaiting: new Trend("waiting_Order_OrderStatusActionMap_2"),
        requestRate: new Counter("rps_Order_OrderStatusActionMap_2"),
        http_reqs: new Counter("sample_Order_OrderStatusActionMap_2"),
    },
    News_V2: {
        errorCount: new Counter("error_count_News_V2"),
        errorRate: new Rate("error_rate_News_V2"),
        httpDuration: new Trend("duration_News_V2"),
        httpWaiting: new Trend("waiting_News_V2"),
        requestRate: new Counter("rps_News_V2"),
        http_reqs: new Counter("sample_News_V2"),
    },
    Mutualfund_User_RiskProfile: {
    ...
    User_Watchlist_WatchlistID: {
        errorCount: new Counter("error_count_User_Watchlist_WatchlistID"),
        errorRate: new Rate("error_rate_User_Watchlist_WatchlistID"),
        httpDuration: new Trend("duration_User_Watchlist_WatchlistID"),
        httpWaiting: new Trend("waiting_User_Watchlist_WatchlistID"),
        requestRate: new Counter("rps_User_Watchlist_WatchlistID"),
        http_reqs: new Counter("sample_User_Watchlist_WatchlistID"),
    },
    Inbox_V1: {
        errorCount: new Counter("error_count_Inbox_V1"),
        errorRate: new Rate("error_rate_Inbox_V1"),
        httpDuration: new Trend("duration_Inbox_V1"),
        httpWaiting: new Trend("waiting_Inbox_V1"),
        requestRate: new Counter("rps_Inbox_V1"),
        http_reqs: new Counter("sample_Inbox_V1"),
    },
    Auth_Protected_AccountCenter_Status_2: {
        errorCount: new Counter("error_count_Auth_Protected_AccountCenter_Status_2"),
        errorRate: new Rate("error_rate_Auth_Protected_AccountCenter_Status_2"),
        httpDuration: new Trend("duration_Auth_Protected_AccountCenter_Status_2"),
        httpWaiting: new Trend("waiting_Auth_Protected_AccountCenter_Status_2"),
        requestRate: new Counter("rps_Auth_Protected_AccountCenter_Status_2"),
        http_reqs: new Counter("sample_Auth_Protected_AccountCenter_Status_2"),
    },
    Mutualfund_User_Filter: {
...
export function handleSummary(data) {
    ...
    if(`${__ENV.RUNBY}`=='Manual'){
        return {
            [`../../Report/OMO_Android/Test1/Manual/${__ENV.RUNBY}_Detail_Test1_${dateStr}_${timeStr}.html`]: htmlReport(data),
            'stdout': textSummary(data, { indent: ' ', enableColors: true }),
        };
    } else if(`${__ENV.RUNBY}`=='Regression'){
        return {
            [`../../Report/OMO_Android/Test1/Regression/${__ENV.RUNBY}_Detail_Test1_${dateStr}_${timeStr}.html`]: htmlReport(data),
            'stdout': textSummary(data, { indent: ' ', enableColors: true }),
        };
    }
}