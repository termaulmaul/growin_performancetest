...
const Homescreen = {
    Gamification_Tier: {
        errorCount: new Counter("error_count_Gamification_Tier"),
        errorRate: new Rate("error_rate_Gamification_Tier"),
        httpDuration: new Trend("duration_Gamification_Tier"),
        httpWaiting: new Trend("waiting_Gamification_Tier"),
        requestRate: new Counter("rps_Gamification_Tier"),
        http_reqs: new Counter("sample_Gamification_Tier"),
    },
    Gamification_Reward_User_TierID: {
        errorCount: new Counter("error_count_Gamification_Reward_User_TierID"),
        errorRate: new Rate("error_rate_Gamification_Reward_User_TierID"),
        httpDuration: new Trend("duration_Gamification_Reward_User_TierID"),
        httpWaiting: new Trend("waiting_Gamification_Reward_User_TierID"),
        requestRate: new Counter("rps_Gamification_Reward_User_TierID"),
        http_reqs: new Counter("sample_Gamification_Reward_User_TierID"),
    },
    Gamification_Reward_Redeemed_TierID: {
        errorCount: new Counter("error_count_Gamification_Reward_Redeemed_TierID"),
        errorRate: new Rate("error_rate_Gamification_Reward_Redeemed_TierID"),
        httpDuration: new Trend("duration_Gamification_Reward_Redeemed_TierID"),
        httpWaiting: new Trend("waiting_Gamification_Reward_Redeemed_TierID"),
        requestRate: new Counter("rps_Gamification_Reward_Redeemed_TierID"),
        http_reqs: new Counter("sample_Gamification_Reward_Redeemed_TierID"),
    },
    Gamification_Reward_Redeem: {
        errorCount: new Counter("error_count_Gamification_Reward_Redeem"),
        errorRate: new Rate("error_rate_Gamification_Reward_Redeem"),
        httpDuration: new Trend("duration_Gamification_Reward_Redeem"),
        httpWaiting: new Trend("waiting_Gamification_Reward_Redeem"),
        requestRate: new Counter("rps_Gamification_Reward_Redeem"),
