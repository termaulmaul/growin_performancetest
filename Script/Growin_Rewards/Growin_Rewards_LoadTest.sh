...
# chmod +x Growin_Rewards_LoadTest.sh
...
../../k6 run Growin_Rewards_LoadTest.js -e RUNBY="$RUNBY" -e ENV="$ENV" -e USER="$USER" -e DURATION="$DURATION" -e NUMSTART="$NUMSTART" --out dashboard=export=../../Report/Growin_Rewards/LoadTest/"$RUNBY"_"$RUNTYPE"_${dateStr}_${timeStr}_72.html