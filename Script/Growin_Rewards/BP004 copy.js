...
// ##READ ME
//BP004 - Transaction History
//RUN QA : ../../k6 run BP004.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=98 --out dashboard=export=../../Report/Growin_Rewards/BP004/Manual/Manual_DryRun_1023_1058_BP004_Local.html
//RUN INT: ../../k6 run BP004.js -e RUNBY=Manual -e ENV=INT -e USER=316 -e DURATION=1m -e NUMSTART=101 --out dashboard=export=../../Report/Growin_Rewards/BP004/Manual/Manual_DryRun_1111_2113_BP004_Local.html
//RUN STRESS TEST: ../../k6 run BP004.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../Report/Growin_Rewards/BP004/Manual/Manual_DryRun_1022_1128_BP004_Local.html
...
// /gamification/api/v2/transaction/history
// /gamification/api/v2/transaction/history/:date
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../Report/Growin_Rewards/BP004/Manual/${__ENV.RUNBY}_Detail_BP004_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../Report/Growin_Rewards/BP004/Regression/${__ENV.RUNBY}_Detail_BP004_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
