# enchange_BP001 — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_BP001.js` |
| Original | `BP001.js` |
| Runner | `Growin_Auth_AdminPermission_Create/Growin_Auth_AdminPermission_Create.js` |
| Config | env-driven |
...
## Context
k6 sibling. Original preserved. Refresh v1: R1, R2, R4, R6.
...
| Command | Result |
| --- | --- |
| `node --check enchange_BP001.js` | see `.refresh_report.json` |
