# enchange_Growin_Auth_AdminPermission_Create — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_Auth_AdminPermission_Create.js` |
| Original | `Growin_Auth_AdminPermission_Create.js` |
| Runner | `Script/Growin_Auth_AdminPermission_Create/enchange_Growin_Auth_AdminPermission_Create.js` |
| Config | env-driven |
| Suite | `Growin_Auth_AdminPermission_Create` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_Auth_AdminPermission_Create.js` | see `.refresh_report.json` |
