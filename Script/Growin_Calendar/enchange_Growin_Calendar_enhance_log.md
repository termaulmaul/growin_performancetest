# enchange_Growin_Calendar — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_Calendar.js` |
| Original | `Growin_Calendar.js` |
| Runner | `Script/Growin_Calendar/enchange_Growin_Calendar.js` |
| Config | env-driven |
| Suite | `Growin_Calendar` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_Calendar.js` | see `.refresh_report.json` |
