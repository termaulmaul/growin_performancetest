...
const Homepage = {
    ...
    Aauth_GetConfig: {
        errorCount: new Counter("error_count_Aauth_GetConfig"),
        errorRate: new Rate("error_rate_Aauth_GetConfig"),
        httpDuration: new Trend("duration_Aauth_GetConfig"),
        httpWaiting: new Trend("waiting_Aauth_GetConfig"),
        requestRate: new Counter("rps_Aauth_GetConfig"),
        http_reqs: new Counter("sample_Aauth_GetConfig"),
    },
    ...
    Auth_AccountCenter_Status: {
        errorCount: new Counter("error_count_Auth_AccountCenter_Status"),
        errorRate: new Rate("error_rate_Auth_AccountCenter_Status"),
        httpDuration: new Trend("duration_Auth_AccountCenter_Status"),
        httpWaiting: new Trend("waiting_Auth_AccountCenter_Status"),
        requestRate: new Counter("rps_Auth_AccountCenter_Status"),
        http_reqs: new Counter("sample_Auth_AccountCenter_Status"),
    },
    ...
    Auth_Client_Selected: {
        errorCount: new Counter("error_count_Auth_Client_Selected"),
        errorRate: new Rate("error_rate_Auth_Client_Selected"),
        httpDuration: new Trend("duration_Auth_Client_Selected"),
        httpWaiting: new Trend("waiting_Auth_Client_Selected"),
        requestRate: new Counter("rps_Auth_Client_Selected"),
        http_reqs: new Counter("sample_Auth_Client_Selected"),
    },
    User_Banner_Promo: {
    ...
    Auth_AccountCenter_Switchables: {
        errorCount: new Counter("error_count_Auth_AccountCenter_Switchables"),
        errorRate: new Rate("error_rate_Auth_AccountCenter_Switchables"),
        httpDuration: new Trend("duration_Auth_AccountCenter_Switchables"),
        httpWaiting: new Trend("waiting_Auth_AccountCenter_Switchables"),
        requestRate: new Counter("rps_Auth_AccountCenter_Switchables"),
        http_reqs: new Counter("sample_Auth_AccountCenter_Switchables"),
    },
