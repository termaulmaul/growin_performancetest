# enchange_Growin_News — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_News.js` |
| Original | `Growin_News.js` |
| Runner | `Script/Growin_News/enchange_Growin_News.js` |
| Config | env-driven |
| Suite | `Growin_News` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_News.js` | see `.refresh_report.json` |
