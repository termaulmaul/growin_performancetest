...
const Home = {
    ...
    User_Protected_Portfolio_Consolidated: {
        errorCount: new Counter("error_count_User_Protected_Portfolio_Consolidated"),
        errorRate: new Rate("error_rate_User_Protected_Portfolio_Consolidated"),
        httpDuration: new Trend("duration_User_Protected_Portfolio_Consolidated"),
        httpWaiting: new Trend("waiting_User_Protected_Portfolio_Consolidated"),
        requestRate: new Counter("rps_User_Protected_Portfolio_Consolidated"),
        http_reqs: new Counter("sample_User_Protected_Portfolio_Consolidated"),
    },
    User_Watchlistgroup: {
