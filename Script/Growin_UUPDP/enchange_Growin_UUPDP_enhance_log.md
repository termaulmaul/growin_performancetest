# enchange_Growin_UUPDP — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_UUPDP.js` |
| Original | `Growin_UUPDP.js` |
| Runner | `Script/Growin_UUPDP/enchange_Growin_UUPDP.js` |
| Config | env-driven |
| Suite | `Growin_UUPDP` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_UUPDP.js` | see `.refresh_report.json` |
