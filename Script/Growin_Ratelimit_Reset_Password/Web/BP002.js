...
const Home = {
    ...
    User_Watchlist_ByWatchlistGroupId: {
        errorCount: new Counter("error_count_User_Watchlist_ByWatchlistGroupId"),
        errorRate: new Rate("error_rate_User_Watchlist_ByWatchlistGroupId"),
        httpDuration: new Trend("duration_User_Watchlist_ByWatchlistGroupId"),
        httpWaiting: new Trend("waiting_User_Watchlist_ByWatchlistGroupId"),
        requestRate: new Counter("rps_User_Watchlist_ByWatchlistGroupId"),
        http_reqs: new Counter("sample_User_Watchlist_ByWatchlistGroupId"),
    },
    News: {
    ...
    News_IsSharia0_Items5_Page1: {
        errorCount: new Counter("error_count_News_IsSharia0_Items5_Page1"),
        errorRate: new Rate("error_rate_News_IsSharia0_Items5_Page1"),
        httpDuration: new Trend("duration_News_IsSharia0_Items5_Page1"),
        httpWaiting: new Trend("waiting_News_IsSharia0_Items5_Page1"),
        requestRate: new Counter("rps_News_IsSharia0_Items5_Page1"),
        http_reqs: new Counter("sample_News_IsSharia0_Items5_Page1"),
    },
    Auth_Protected_GetConfig: {
