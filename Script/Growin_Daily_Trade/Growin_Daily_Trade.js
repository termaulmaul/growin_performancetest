...
// Run Single BP Web
// ../../k6 run Growin_Daily_Trade.js -e RUNBY=Manual -e ENV=INT -e USER=335 -e DURATION=15m -e NUMSTART=1 -e SCENARIO=BP001 -e PLATFORM=Web --out dashboard=export=../../Report/Growin_Daily_Trade/Web/BP001/Manual/Manual_DryRun_0316_1001_BP001.html
...
export function handleSummary(data) {
    try {
        ...
        if (runby === 'Manual') {
            const htmlPath = `../../Report/Growin_Daily_Trade/${platform}/${bp_name}/Manual/${runby}_Detail_${bp_name}_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../Report/Growin_Daily_Trade/${platform}/${bp_name}/Regression/${runby}_Detail_${bp_name}_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../Report/Growin_Daily_Trade/${platform}/LoadTest/${runby}_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
