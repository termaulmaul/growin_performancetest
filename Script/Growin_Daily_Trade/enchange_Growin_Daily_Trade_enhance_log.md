# enchange_Growin_Daily_Trade — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_Daily_Trade.js` |
| Original | `Growin_Daily_Trade.js` |
| Runner | `Script/Growin_Daily_Trade/enchange_Growin_Daily_Trade.js` |
| Config | env-driven |
| Suite | `Growin_Daily_Trade` |
| Flow | `-` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_Daily_Trade.js` | see `.refresh_report.json` |
