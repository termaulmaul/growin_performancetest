...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../Report/Growin_AI_Summarizer/BP004/Manual/${__ENV.RUNBY}_Detail_BP004_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../Report/Growin_AI_Summarizer/BP004/Regression/${__ENV.RUNBY}_Detail_BP004_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
