...
const StockDetailKeystatTab = {
    ...
    Marketdata_Gpt_ConversationActivityInsert_1: {
        errorCount: new Counter("error_count_Marketdata_Gpt_ConversationActivityInsert_1"),
        errorRate: new Rate("error_rate_Marketdata_Gpt_ConversationActivityInsert_1"),
        httpDuration: new Trend("duration_Marketdata_Gpt_ConversationActivityInsert_1"),
        httpWaiting: new Trend("waiting_Marketdata_Gpt_ConversationActivityInsert_1"),
        requestRate: new Counter("rps_Marketdata_Gpt_ConversationActivityInsert_1"),
        http_reqs: new Counter("sample_Marketdata_Gpt_ConversationActivityInsert_1"),
    },
    Marketdata_Gpt_ConversationActivityInsert_2: {
