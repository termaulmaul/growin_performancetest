...
// ##READ ME
//BP002 - Chat Room
//RUN QA : ../../../k6 run BP002_Suhu.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=75 --out dashboard=export=../../../Report/Growin_Community/BP002/Manual/Manual_DryRun_1103_1631_BP002_Web_Suhu_Local.html
//RUN INT: ../../../k6 run BP002_Suhu.js -e RUNBY=Manual -e ENV=INT -e USER=58 -e DURATION=10m -e NUMSTART=101 --out dashboard=export=../../../Report/Growin_Community/BP002/Manual/Manual_DryRun_1023_1656_BP002_Web_Suhu_Local.html
//RUN STRESS TEST: ../../../k6 run BP002_Suhu.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Community/BP002/Manual/Manual_DryRun_2021_1128_BP002_Web_Suhu_Local.html
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Community/BP002/Manual/${__ENV.RUNBY}_Detail_BP002_Web_Suhu_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Community/BP002/Regression/${__ENV.RUNBY}_Detail_BP002_Web_Suhu_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Community/BP002/LoadTest/${__ENV.RUNBY}_Detail_BP002_Web_Suhu_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
