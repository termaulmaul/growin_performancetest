# enchange_Growin_Community_Web_LoadTest — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_Growin_Community_Web_LoadTest.js` |
| Original | `Growin_Community_Web_LoadTest.js` |
| Runner | `Script/Growin_Community/Web/enchange_Growin_Community_Web_LoadTest.js` |
| Config | env-driven |
| Suite | `Growin_Community` |
| Flow | `Web` |
...
| Command | Result |
| --- | --- |
| `node --check enchange_Growin_Community_Web_LoadTest.js` | see `.refresh_report.json` |
