...
//RUN QA : ../../../k6 run BP011.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=84 --out dashboard=export=../../../Report/Growin_Community/BP011/Manual/Manual_DryRun_1111_1507_BP011_Web_Local.html
//RUN INT: ../../../k6 run BP011.js -e RUNBY=Manual -e ENV=INT -e USER=58 -e DURATION=10m -e NUMSTART=101 --out dashboard=export=../../../Report/Growin_Community/BP011/Manual/Manual_DryRun_1023_1656_BP011_Web_Local.html
//RUN STRESS TEST: ../../../k6 run BP011.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Community/BP011/Manual/Manual_DryRun_2021_1128_BP011_Web_Local.html
...
const CommunityMemberKickRequestApproval = {
    Socialinvesting_Social_GetKickRequest: {
        errorCount: new Counter("error_count_010_01_01_Socialinvesting_Social_GetKickRequest"),
        errorRate: new Rate("error_rate_010_01_01_Socialinvesting_Social_GetKickRequest"),
        httpDuration: new Trend("duration_010_01_01_Socialinvesting_Social_GetKickRequest"),
        httpWaiting: new Trend("waiting_010_01_01_Socialinvesting_Social_GetKickRequest"),
        requestRate: new Counter("rps_010_01_01_Socialinvesting_Social_GetKickRequest"),
        http_reqs: new Counter("sample_010_01_01_Socialinvesting_Social_GetKickRequest"),
    },
    Socialinvesting_Social_UpdateKickRequest: {
        errorCount: new Counter("error_count_010_01_02_Socialinvesting_Social_UpdateKickRequest"),
        errorRate: new Rate("error_rate_010_01_02_Socialinvesting_Social_UpdateKickRequest"),
        httpDuration: new Trend("duration_010_01_02_Socialinvesting_Social_UpdateKickRequest"),
        httpWaiting: new Trend("waiting_010_01_02_Socialinvesting_Social_UpdateKickRequest"),
        requestRate: new Counter("rps_010_01_02_Socialinvesting_Social_UpdateKickRequest"),
        http_reqs: new Counter("sample_010_01_02_Socialinvesting_Social_UpdateKickRequest"),
    },
    Socialinvesting_Social_RemoveByAdmin: {
        errorCount: new Counter("error_count_010_01_03_Socialinvesting_Social_RemoveByAdmin"),
        errorRate: new Rate("error_rate_010_01_03_Socialinvesting_Social_RemoveByAdmin"),
        httpDuration: new Trend("duration_010_01_03_Socialinvesting_Social_RemoveByAdmin"),
        httpWaiting: new Trend("waiting_010_01_03_Socialinvesting_Social_RemoveByAdmin"),
        requestRate: new Counter("rps_010_01_03_Socialinvesting_Social_RemoveByAdmin"),
        http_reqs: new Counter("sample_010_01_03_Socialinvesting_Social_RemoveByAdmin"),
    },
};
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Community/BP011/Manual/${__ENV.RUNBY}_Detail_BP011_Web_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Community/BP011/Regression/${__ENV.RUNBY}_Detail_BP011_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Community/BP011/LoadTest/${__ENV.RUNBY}_Detail_BP011_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
