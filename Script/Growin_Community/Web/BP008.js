...
const CommunityDetailAdminSuhu = {
    ...
    Socialinvesting_Channel_Statistic: {
        errorCount: new Counter("error_count_Socialinvesting_Channel_Statistic"),
        errorRate: new Rate("error_rate_Socialinvesting_Channel_Statistic"),
        httpDuration: new Trend("duration_Socialinvesting_Channel_Statistic"),
        httpWaiting: new Trend("waiting_Socialinvesting_Channel_Statistic"),
        requestRate: new Counter("rps_Socialinvesting_Channel_Statistic"),
