...
const StockPick = {
    ...
    Socialinvesting_CreateStockPick: {
        errorCount: new Counter("error_count_Socialinvesting_CreateStockPick"),
        errorRate: new Rate("error_rate_Socialinvesting_CreateStockPick"),
        httpDuration: new Trend("duration_Socialinvesting_CreateStockPick"),
        httpWaiting: new Trend("waiting_Socialinvesting_CreateStockPick"),
        requestRate: new Counter("rps_Socialinvesting_CreateStockPick"),
        http_reqs: new Counter("sample_Socialinvesting_CreateStockPick"),
    },
    Socialinvesting_StockPickID: {
        errorCount: new Counter("error_count_Socialinvesting_Delete_StockPickID"),
        errorRate: new Rate("error_rate_Socialinvesting_Delete_StockPickID"),
        httpDuration: new Trend("duration_Socialinvesting_Delete_StockPickID"),
        httpWaiting: new Trend("waiting_Socialinvesting_Delete_StockPickID"),
        requestRate: new Counter("rps_Socialinvesting_Delete_StockPickID"),
        http_reqs: new Counter("sample_Socialinvesting_Delete_StockPickID"),
    },
    Search_QuerySocialInvesting: {
