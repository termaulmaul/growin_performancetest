// Command
// Run Multiple BP
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=LoadTest -e ENV=INT -e USER=316 -e DURATION=1h --out dashboard=export=../../../Report/Growin_Community/Web/LoadTest/Manual_LoadTest_0107_1450.html

// Run Single BP
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP001 --out dashboard=export=../../../Report/Growin_Community/Web/BP001/Manual/Manual_DryRun_0107_1452_BP001_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP002 --out dashboard=export=../../../Report/Growin_Community/Web/BP002/Manual/Manual_DryRun_1217_1433_BP002_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP003 --out dashboard=export=../../../Report/Growin_Community/Web/BP003/Manual/Manual_DryRun_1217_1440_BP003_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=25 -e DURATION=5m -e SCENARIO=BP004 --out dashboard=export=../../../Report/Growin_Community/Web/BP004/Manual/Manual_DryRun_1219_1442_BP004_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP005 --out dashboard=export=../../../Report/Growin_Community/Web/BP005/Manual/Manual_DryRun_0106_1531_BP005_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP006 --out dashboard=export=../../../Report/Growin_Community/Web/BP006/Manual/Manual_DryRun_1223_1654_BP006_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP007 --out dashboard=export=../../../Report/Growin_Community/Web/BP007/Manual/Manual_DryRun_1218_2016_BP007_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=75 -e DURATION=5m -e SCENARIO=BP008 --out dashboard=export=../../../Report/Growin_Community/Web/BP008/Manual/Manual_DryRun_1203_2010_BP008_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP009 --out dashboard=export=../../../Report/Growin_Community/Web/BP009/Manual/Manual_DryRun_1217_1455_BP009_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP010 --out dashboard=export=../../../Report/Growin_Community/Web/BP010/Manual/Manual_DryRun_1217_1501_BP010_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=50 -e DURATION=5m -e SCENARIO=BP011 --out dashboard=export=../../../Report/Growin_Community/Web/BP011/Manual/Manual_DryRun_1203_2018_BP011_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP012 --out dashboard=export=../../../Report/Growin_Community/Web/BP012/Manual/Manual_DryRun_1217_1507_BP012_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=25 -e DURATION=5m -e SCENARIO=BP013 --out dashboard=export=../../../Report/Growin_Community/Web/BP013/Manual/Manual_DryRun_1203_2019_BP013_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest.js -e RUNBY=Manual -e ENV=INT -e USER=50 -e DURATION=5m -e SCENARIO=BP014 --out dashboard=export=../../../Report/Growin_Community/Web/BP014/Manual/Manual_DryRun_1203_2020_BP014_Local.html
...
function getUserCredentials(userNum) {
    ...
    if (env === 'DEV' || env === 'QA') {
        ...
        formattedNum = String(userNum).padStart(4, '0');
        email = 'MOSTNG' + formattedNum + '@guysmail.com';
    } else if (env === 'INT') {
        formattedNum = String(userNum).padStart(4, '0');
...
// ✅ SETUP FUNCTION - WITH USER POOL MANAGEMENT
        ...
        for (let batchNum = 0; batchNum < numBatches; batchNum++) {
            ...
            for (let i = batchStart; i < batchEnd; i++) {
                ...
                if (loginRes.status === 200) {
                    ...
                    console.log(`   Y VU${vuId} (${credentials.email}, User${userAllocation.userNum}) LOGIN FAILED - Status: ${loginRes.body}`);
                    ...
                    if (pinRes.status === 200) {
                        totalPinSuccess++;
                        tokens[vuId].pin_token = pinRes.json().data.pin_token;
                    } else {
                        totalPinFailed++;
                        if (totalPinFailed <= 3) {
                            console.error(`   ❌ VU${vuId} (${credentials.email}, User${userAllocation.userNum}) PIN FAILED - Status: ${pinRes.status}`);
                        }
                    }
                    
                } else {
                    totalLoginFailed++;
                    if (totalLoginFailed <= 3) {
                        console.error(`   ❌ VU${vuId} (${credentials.email}, User${userAllocation.userNum}) LOGIN FAILED - Status: ${loginRes.status}`);
                    }
                    tokens[vuId] = { 
                        email: credentials.email,
                        userNum: userAllocation.userNum,
