...
// Run Single BP
// ../../../k6 run Growin_Community_Web_LoadTest_copy_2.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP001 --out dashboard=export=../../../Report/Growin_Community/Web/BP001/Manual/Manual_DryRun_0127_1430_BP001_Local.html
...
// ../../../k6 run Growin_Community_Web_LoadTest_copy_2.js -e RUNBY=Manual -e ENV=INT -e USER=25 -e DURATION=5m -e SCENARIO=BP004 --out dashboard=export=../../../Report/Growin_Community/Web/BP004/Manual/Manual_DryRun_0127_1449_BP004_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest_copy_2.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=5m -e SCENARIO=BP005 --out dashboard=export=../../../Report/Growin_Community/Web/BP005/Manual/Manual_DryRun_0127_1635_BP005_Local.html
// ../../../k6 run Growin_Community_Web_LoadTest_copy_2.js -e RUNBY=Manual -e ENV=INT -e USER=300 -e DURATION=2m -e SCENARIO=BP006 --out dashboard=export=../../../Report/Growin_Community/Web/BP006/Manual/Manual_DryRun_1227_2232_BP006_Local.html
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            ...
            const htmlPath = `../../../Report/Growin_Community/Web/LoadTest_${__ENV.RUNBY}_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
