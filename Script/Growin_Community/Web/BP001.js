...
const YourCommunities = {
    ...
    ChatStreamIoApi_Channels: {
        errorCount: new Counter("error_count_ChatStreamIoApi_Channels"),
        errorRate: new Rate("error_rate_ChatStreamIoApi_Channels"),
        httpDuration: new Trend("duration_ChatStreamIoApi_Channels"),
        httpWaiting: new Trend("waiting_ChatStreamIoApi_Channels"),
        requestRate: new Counter("rps_ChatStreamIoApi_Channels"),
        http_reqs: new Counter("sample_ChatStreamIoApi_Channels"),
    },
    ChatStreamIoApi_Connect: {
        errorCount: new Counter("error_count_ChatStreamIoApi_Connect"),
        errorRate: new Rate("error_rate_ChatStreamIoApi_Connect"),
        httpDuration: new Trend("duration_ChatStreamIoApi_Connect"),
        httpWaiting: new Trend("waiting_ChatStreamIoApi_Connect"),
        requestRate: new Counter("rps_ChatStreamIoApi_Connect"),
