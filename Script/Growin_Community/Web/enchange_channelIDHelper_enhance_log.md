# enchange_channelIDHelper — Enhancement Log

| Field | Value |
| --- | --- |
| Script | `enchange_channelIDHelper.js` |
| Original | `channelIDHelper.js` |
| Runner | `Growin_Community/Growin_Community.js` |
| Config | env-driven |
...
| Command | Result |
| --- | --- |
| `node --check enchange_channelIDHelper.js` | see `.refresh_report.json` |
