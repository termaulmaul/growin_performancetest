...
//RUN QA : ../../../k6 run BP010.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=16 --out dashboard=export=../../../Report/Growin_Community/BP010/Manual/Manual_DryRun_1111_1506_BP010_Web_Local.html
//RUN INT: ../../../k6 run BP010.js -e RUNBY=Manual -e ENV=INT -e USER=58 -e DURATION=10m -e NUMSTART=101 --out dashboard=export=../../../Report/Growin_Community/BP010/Manual/Manual_DryRun_1023_1656_BP010_Web_Local.html
//RUN STRESS TEST: ../../../k6 run BP010.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Community/BP010/Manual/Manual_DryRun_2021_1128_BP010_Web_Local.html
...
const CommunityMember = {
    Social_ProfilesByJoinStatus: {
        errorCount: new Counter("error_count_009_01_01_Social_ProfilesByJoinStatus"),
        errorRate: new Rate("error_rate_009_01_01_Social_ProfilesByJoinStatus"),
        httpDuration: new Trend("duration_009_01_01_Social_ProfilesByJoinStatus"),
        httpWaiting: new Trend("waiting_009_01_01_Social_ProfilesByJoinStatus"),
        requestRate: new Counter("rps_009_01_01_Social_ProfilesByJoinStatus"),
        http_reqs: new Counter("sample_009_01_01_Social_ProfilesByJoinStatus"),
    },
};
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Community/BP010/Manual/${__ENV.RUNBY}_Detail_BP010_Web_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Community/BP010/Regression/${__ENV.RUNBY}_Detail_BP010_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Community/BP010/LoadTest/${__ENV.RUNBY}_Detail_BP010_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
