...
//RUN QA : ../../../k6 run BP007.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=83 --out dashboard=export=../../../Report/Growin_Community/BP007/Manual/Manual_DryRun_1111_1401_BP007_Web_Local.html
//RUN INT: ../../../k6 run BP007.js -e RUNBY=Manual -e ENV=INT -e USER=1 -e DURATION=10m -e NUMSTART=1 --out dashboard=export=../../../Report/Growin_Community/BP007/Manual/Manual_DryRun_1113_2125_BP007_Web_Local.html
//RUN STRESS TEST: ../../../k6 run BP007.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Community/BP007/Manual/Manual_DryRun_2021_1128_BP007_Web_Local.html
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Community/BP007/Manual/${__ENV.RUNBY}_Detail_BP007_Web_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Community/BP007/Regression/${__ENV.RUNBY}_Detail_BP007_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Community/BP007/LoadTest/${__ENV.RUNBY}_Detail_BP007_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
