...
const CommunityDetailUserTrialJoinLeave = {
    Socialinvesting_Channel_GetList: {
        errorCount: new Counter("error_count_Socialinvesting_Channel_GetList"),
        errorRate: new Rate("error_rate_Socialinvesting_Channel_GetList"),
        httpDuration: new Trend("duration_Socialinvesting_Channel_GetList"),
        httpWaiting: new Trend("waiting_Socialinvesting_Channel_GetList"),
        requestRate: new Counter("rps_Socialinvesting_Channel_GetList"),
        http_reqs: new Counter("sample_Socialinvesting_Channel_GetList"),
    },
    Socialinvesting_Channel_GetProfile: {
        errorCount: new Counter("error_count_Socialinvesting_Channel_GetProfile"),
        errorRate: new Rate("error_rate_Socialinvesting_Channel_GetProfile"),
        httpDuration: new Trend("duration_Socialinvesting_Channel_GetProfile"),
        httpWaiting: new Trend("waiting_Socialinvesting_Channel_GetProfile"),
        requestRate: new Counter("rps_Socialinvesting_Channel_GetProfile"),
        http_reqs: new Counter("sample_Socialinvesting_Channel_GetProfile"),
    },
    Socialinvesting_CommunityProfile_GetProfile: {
    ...
    Socialinvesting_Social_Leave: {
        errorCount: new Counter("error_count_Socialinvesting_Social_Leave"),
        errorRate: new Rate("error_rate_Socialinvesting_Social_Leave"),
        httpDuration: new Trend("duration_Socialinvesting_Social_Leave"),
        httpWaiting: new Trend("waiting_Socialinvesting_Social_Leave"),
        requestRate: new Counter("rps_Socialinvesting_Social_Leave"),
        http_reqs: new Counter("sample_Socialinvesting_Social_Leave"),
    },
    ...
    Socialinvesting_Social_Join: {
        errorCount: new Counter("error_count_Socialinvesting_Social_Join"),
        errorRate: new Rate("error_rate_Socialinvesting_Social_Join"),
        httpDuration: new Trend("duration_Socialinvesting_Social_Join"),
        httpWaiting: new Trend("waiting_Socialinvesting_Social_Join"),
        requestRate: new Counter("rps_Socialinvesting_Social_Join"),
        http_reqs: new Counter("sample_Socialinvesting_Social_Join"),
    },
};
