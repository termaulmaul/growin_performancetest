...
// ##READ ME
//BP008 - Community Detail Admin Suhu
//RUN QA : ../../../k6 run BP008.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=83 --out dashboard=export=../../../Report/Growin_Community/Web/BP008/Manual/Manual_DryRun_1111_1401_BP008_Web_Local.html
//RUN INT: ../../../k6 run BP008copy.js -e RUNBY=Manual -e ENV=INT -e USER=25 -e DURATION=10m -e NUMSTART=2051 --out dashboard=export=../../../Report/Growin_Community/Web/BP008/Manual/Manual_DryRun_1126_1100_BP008_Web_Local.html
//RUN STRESS TEST: ../../../k6 run BP008.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Community/Web/BP008/Manual/Manual_DryRun_2021_1128_BP008_Web_Local.html
...
export default function (data) {
    ...
    let res = http.post(base_url + '/socialinvesting/api/v1/channel/get-list', { headers: stepOneHeaders });
    ...
    if (res.status === 200) {
        ...
        if (`${__ENV.ENV}` != 'INT') {
            console.error(`No Channel ID available || ${res.body}`);
        }
    }
    ...
    if (token) {
        const urls = [
            ...
            // base_url + `/socialinvesting/api/v1/social/get-kick-request?channel_id=${channel_id}&limit=10&page=1`,
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Community/Web/BP008/Manual/${__ENV.RUNBY}_Detail_BP008_Web_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Community/Web/BP008/Regression/${__ENV.RUNBY}_Detail_BP008_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Community/Web/BP008/LoadTest/${__ENV.RUNBY}_Detail_BP008_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
