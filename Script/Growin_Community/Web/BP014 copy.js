...
// ##READ ME
//BP014 - Kick by Admin
//RUN QA : ../../../k6 run BP014.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=16 --out dashboard=export=../../../Report/Growin_Community/Web/BP014/Manual/Manual_DryRun_1112_1059_BP014_Web_Local.html
//RUN INT: ../../../k6 run BP014.js -e RUNBY=Manual -e ENV=INT -e USER=1 -e DURATION=10m -e NUMSTART=1 --out dashboard=export=../../../Report/Growin_Community/Web/BP014/Manual/Manual_DryRun_1117_1459_BP014_Web_Local.html
//RUN STRESS TEST: ../../../k6 run BP014.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Community/Web/BP014/Manual/Manual_DryRun_2021_1128_BP014_Web_Local.html
...
export default function (data) {
    ...
    if (token) {
        const urls = [
            base_url + `/socialinvesting/api/v1/social/remove-by-admin?channel_id=${channelId}`,
        ];
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Community/Web/BP014/Manual/${__ENV.RUNBY}_Detail_BP014_Web_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Community/Web/BP014/Regression/${__ENV.RUNBY}_Detail_BP014_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Community/Web/BP014/LoadTest/${__ENV.RUNBY}_Detail_BP014_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
