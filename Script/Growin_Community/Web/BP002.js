...
const ChatRoom = {
    ...
    ChatStreamIoApi_Channels_Messaging_1: {
        errorCount: new Counter("error_count_ChatStreamIoApi_Channels_Messaging_1"),
        errorRate: new Rate("error_rate_ChatStreamIoApi_Channels_Messaging_1"),
        httpDuration: new Trend("duration_ChatStreamIoApi_Channels_Messaging_1"),
        httpWaiting: new Trend("waiting_ChatStreamIoApi_Channels_Messaging_1"),
        requestRate: new Counter("rps_ChatStreamIoApi_Channels_Messaging_1"),
        http_reqs: new Counter("sample_ChatStreamIoApi_Channels_Messaging_1"),
    },
    ChatStreamIoApi_Channels_Messaging_2: {
        errorCount: new Counter("error_count_ChatStreamIoApi_Channels_Messaging_2"),
        errorRate: new Rate("error_rate_ChatStreamIoApi_Channels_Messaging_2"),
        httpDuration: new Trend("duration_ChatStreamIoApi_Channels_Messaging_2"),
        httpWaiting: new Trend("waiting_ChatStreamIoApi_Channels_Messaging_2"),
        requestRate: new Counter("rps_ChatStreamIoApi_Channels_Messaging_2"),
        http_reqs: new Counter("sample_ChatStreamIoApi_Channels_Messaging_2"),
    },
    ChatStreamIoApi_Members: {
        errorCount: new Counter("error_count_ChatStreamIoApi_Members"),
        errorRate: new Rate("error_rate_ChatStreamIoApi_Members"),
        httpDuration: new Trend("duration_ChatStreamIoApi_Members"),
        httpWaiting: new Trend("waiting_ChatStreamIoApi_Members"),
        requestRate: new Counter("rps_ChatStreamIoApi_Members"),
