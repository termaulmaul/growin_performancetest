...
const CommunityDetailUserTrialSwitch = {
    ...
    Socialinvesting_Social_Switch: {
        errorCount: new Counter("error_count_Socialinvesting_Social_Switch"),
        errorRate: new Rate("error_rate_Socialinvesting_Social_Switch"),
        httpDuration: new Trend("duration_Socialinvesting_Social_Switch"),
        httpWaiting: new Trend("waiting_Socialinvesting_Social_Switch"),
        requestRate: new Counter("rps_Socialinvesting_Social_Switch"),
