...
//RUN QA : ../../../k6 run BP005.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=42 --out dashboard=export=../../../Report/Growin_Community/BP005/Manual/Manual_DryRun_1112_1106_BP005_Web_Local.html
//RUN INT: ../../../k6 run BP005.js -e RUNBY=Manual -e ENV=INT -e USER=1 -e DURATION=10m -e NUMSTART=1 --out dashboard=export=../../../Report/Growin_Community/BP005/Manual/Manual_DryRun_1117_0017_BP005_Web_Local.html
//RUN STRESS TEST: ../../../k6 run BP005.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Community/BP005/Manual/Manual_DryRun_2021_1128_BP005_Web_Local.html
            ...
            if (response.status === 200) {
                ...
                try {
                    ...
                    if (ChannelGetProfile && ChannelGetProfile.data && ChannelGetProfile.data.length > 0) {
                        ...
                        new_Channel_Id = ChannelGetProfile.data[1].channel_id;
                        if (`${__ENV.ENV}` != 'TEST') {
...
export function handleSummary(data) {
    try {
        ...
        if(`${__ENV.RUNBY}`=='Manual'){
            const htmlPath = `../../../Report/Growin_Community/BP005/Manual/${__ENV.RUNBY}_Detail_BP005_Web_${dateStr}_${timeStr}.html`;
            ...
            const htmlPath = `../../../Report/Growin_Community/BP005/Regression/${__ENV.RUNBY}_Detail_BP005_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
            ...
            const htmlPath = `../../../Report/Growin_Community/BP005/LoadTest/${__ENV.RUNBY}_Detail_BP005_Web_${dateStr}_${timeStr}.html`;
            console.log(`Generating HTML: ${htmlPath}`);
