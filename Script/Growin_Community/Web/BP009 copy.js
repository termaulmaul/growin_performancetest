...
//RUN QA : ../../../k6 run BP009.js -e RUNBY=Manual -e ENV=QA -e USER=1 -e DURATION=1m -e NUMSTART=74 --out dashboard=export=../../../Report/Growin_Community/Web/BP009/Manual/Manual_DryRun_1111_1437_BP009_Web_Local.html
//RUN INT: ../../../k6 run BP009.js -e RUNBY=Manual -e ENV=INT -e USER=1 -e DURATION=10m -e NUMSTART=1 --out dashboard=export=../../../Report/Growin_Community/Web/BP009/Manual/Manual_DryRun_1117_1530_BP009_Web_Local.html
//RUN STRESS TEST: ../../../k6 run BP009.js -e RUNBY=Manual -e ENV=INT -e NUMSTART=0 --out dashboard=export=../../../Report/Growin_Community/Web/BP009/Manual/Manual_DryRun_2021_1128_BP009_Web_Local.html
...
export default function (data) {
    ...
    if (token) {
        const urls = [
            base_url + `/socialinvesting/api/v1/social/messages-history?channel_id=${channelId}&message_limit=2`,
        ];
...
export function handleSummary(data) {
    try {
        ...
        const reportFolder = `../../../Report/Growin_Community/Web/BP009/${runBy}`;
